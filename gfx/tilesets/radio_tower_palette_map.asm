	tilepal 0, GRAY, YELLOW, RED, WATER, WATER, GRAY, GRAY, GRAY
	...
	tilepal 0, BROWN, ROOF, ROOF, GRAY, YELLOW, YELLOW, GRAY, GRAY
	tilepal 0, GRAY, GRAY, GRAY, GRAY, WATER, GRAY, GRAY, BROWN
	tilepal 0, BROWN, GRAY, GRAY, GRAY, YELLOW, YELLOW, GRAY, GRAY
