...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    ROOKOWL,        SET_UP_DOLL,       EVENT_DECO_BULBASAUR_DOLL,       SPRITE_BULBASAUR
	decoration DECO_DOLL,    ALCALF,         SET_UP_DOLL,       EVENT_DECO_CHARMANDER_DOLL,      SPRITE_CHARMANDER
	decoration DECO_DOLL,    GILLUCID,       SET_UP_DOLL,       EVENT_DECO_SQUIRTLE_DOLL,        SPRITE_SQUIRTLE
	...
	decoration DECO_DOLL,    BELLEBUD,       SET_UP_DOLL,       EVENT_DECO_WEEDLE_DOLL,          SPRITE_WEEDLE
