...
MonMenuIcons:
	db ICON_BIRD        ; ROOKOWL
	db ICON_BIRD        ; TWISTOWL
	db ICON_BIRD        ; STRIGALE
	db ICON_HUMANSHAPE  ; GLASNOW
	db ICON_HUMANSHAPE  ; GLASLEET
	db ICON_ODDISH      ; BELLEBUD
	db ICON_ODDISH      ; BELLEBEAU
	db ICON_ODDISH      ; BELLEBLOOM
	db ICON_FOX         ; PROCYUX
	db ICON_FOX         ; DURACYON
	db ICON_FISH        ; GILLUCID
	db ICON_FISH        ; SERPIMENT
	db ICON_FOX         ; PUMEOW
	db ICON_FOX         ; TABBEOW
	db ICON_FOX         ; PHANTHER
	db ICON_MONSTER     ; CAVERTH
	db ICON_MONSTER     ; LIONERTH
	db ICON_MONSTER     ; ALCALF
	db ICON_MONSTER     ; CARDINELK
	db ICON_MONSTER     ; SHIMOOSE
