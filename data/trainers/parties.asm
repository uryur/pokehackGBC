...
FalknerGroup:
	...
	db  7, ROOKOWL,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  9, TWISTOWL,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end
...
BugsyGroup:
	...
	db 14, PUMEOW,    TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, ALCALF,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
...
ChampionGroup:
	...
	db 46, SHIMOOSE,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
...
YoungsterGroup:
	...
	db 21, LIONERTH,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, LIONERTH,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, LIONERTH,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, STRIGALE,    TOXIC, QUICK_ATTACK, WHIRLWIND, FLY
	db 38, STRIGALE,    SWIFT, DETECT, STEEL_WING, FLY
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26, ALCALF, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 26, GILLUCID,   WITHDRAW, WATER_GUN, BITE, CURSE
	db 26, BELLEBUD,  LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	db 25, STRIGALE,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	...
	db 27, ALCALF, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, SERPIMENT,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 32, BELLEBUD,  GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, BELLEBEAU,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, BELLEBLOOM,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 25, BELLEBEAU, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
...
BugCatcherGroup:
	...
	db 24, BELLEBEAU, CONFUSION, POISONPOWDER, SUPERSONIC, WHIRLWIND
	db 24, BELLEBEAU, CONFUSION, STUN_SPORE, SUPERSONIC, WHIRLWIND
	db 25, TABBEOW,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 24, BELLEBEAU, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, BELLEBEAU, CONFUSION, POISONPOWDER, SUPERSONIC, GUST
	db 30, BELLEBEAU, CONFUSION, STUN_SPORE, SUPERSONIC, GUST
	db 32, TABBEOW,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 34, BELLEBEAU, PSYBEAM, SLEEP_POWDER, GUST, WHIRLWIND
	db -1 ; end
...
PicnickerGroup:
	...
	db 38, BELLEBLOOM,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end
...
PokefanMGroup:
	...
	db 29, BELLEBUD,  BERRY
	db 29, ALCALF, BERRY
	db 29, GILLUCID,   BERRY
	db -1 ; end
...
RedGroup:
	...
	db 77, BELLEBLOOM,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 77, SHIMOOSE,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 77, SERPIMENT,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 56, STRIGALE,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
